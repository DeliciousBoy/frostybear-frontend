      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-15 w-auto" src="/img/logo.png"
              alt="" />
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <router-link to="/"><a href="#" class="text-xl font-bold text-gray-900">Home</a></router-link>
          <router-link to="/shop"><a href="#" class="text-xl font-bold text-gray-900">Shop</a></router-link>
          <!-- <a href="#" class="text-xl font-bold text-gray-900">Marketplace</a> -->
          <router-link to="/checkout"><a href="#" class="text-xl font-bold text-gray-900">Checkout</a></router-link>
        </div>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <router-link to="/login"><a href="#" class="text-xl font-bold text-gray-900">Log in <span aria-hidden="true">&rarr;</span></a></router-link>
        </div>
      </nav>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                <a href="/"
                  class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-bold text-gray-900 hover:bg-gray-50">Home</a>
                <a href="shop"
                  class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-bold text-gray-900 hover:bg-gray-50">Shop</a>
                <!-- <a href="#"
                  class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-bold text-gray-900 hover:bg-gray-50">Marketplace</a> -->
                <a href="checkout"
                  class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-bold text-gray-900 hover:bg-gray-50">Checkout</a>
              </div>
              <div class="py-6">
                <a href="/login"
                  class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-bold text-gray-900 hover:bg-gray-50">Log
                  in</a>
              </div>
            </div>
          </div>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          ...
          <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Ice cream website is here.</p>
