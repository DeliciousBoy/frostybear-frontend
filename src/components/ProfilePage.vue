  ...
  <div class="flex min-h-screen bg-gray-100">
    ...
    <div class="w-64 bg-white border-r">
      <nav class="py-4">
        ...
        <button
          @click="currentTab = 'changePassword'"
          :class="[
            'block w-full text-left px-6 py-2',
          ...
          <div class="bg-white p-4 rounded shadow">
            ...
            <div class="relative">
              <input
                ...
                required
              />
              <button type="button" @click="toggleOldPassword" class="absolute inset-y-0 right-0 flex items-center pr-3">
                <svg
          ...
          <div class="bg-white p-4 rounded shadow">
            ...
            <div class="relative">
              <input
                ...
                required
              />
              <button type="button" @click="toggleNewPassword" class="absolute inset-y-0 right-0 flex items-center pr-3">
                <svg
          ...
          <div class="bg-white p-4 rounded shadow">
            ...
            <div class="relative">
              <input
                ...
                required
              />
              <button type="button" @click="toggleConfirmNewPassword" class="absolute inset-y-0 right-0 flex items-center pr-3">
                <svg
